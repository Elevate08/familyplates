class RecipeRequest < ApplicationRecord
  ...
  # Fulfils a request when its recipe has a slot on or before today, and not
  # before the earlier of week_start_date and created_at. Scoped to one household:
  # this runs on hot paths and must not scan every household.
